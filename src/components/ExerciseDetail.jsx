...
const ExerciseDetail = (props) => {
  ...
  return (
    <section className="text-gray-600 body-font">
      ...
      <h1 className="text-5xl text-gray-900 mb-10">Exercise Videos</h1>
      <div className="w-full grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6 gap-y-4">
        {exerciseVideos?.slice(0, 8)?.map((item, index) => (
          <a
            ...
            rel="noreferrer"
          >
            <div className=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-600 dark:border-gray-700">
              <img
